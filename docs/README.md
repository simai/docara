...
Целевая архитектура Docara 2, границы авторинга, план миграции и критерии
приёмки находятся в [`docs/specification`](specification/README.md). Это
нормативный источник для работ по упрощению; сгенерированный сайт описывает
только уже реализованный runtime.
