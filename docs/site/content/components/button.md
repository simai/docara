...
Button визуально обозначает элемент действия, но portable Docara сам не
привязывает и не выполняет это действие. Используйте понятный глагол и
обязательно задавайте доступное имя. Ниже показан отключённый образец.
