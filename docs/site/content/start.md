...
Контекст чтения также включён: starter показывает хлебные крошки, оглавление по
H2/H3 и переходы между соседними страницами. Настройки находятся в ветке
`reading`, а пример — на странице `content/guides/getting-started.md`.

Дальше прочитайте [модель файлов](/authoring/project-files/) и
[настройки сайта](/authoring/configuration/), затем откройте
[руководство по контексту чтения](/authoring/reading-context/) и
[руководство по поиску](/authoring/search/). Выбор системной, светлой и тёмной
темы описан в [настройках чтения](/authoring/reader-settings/).
