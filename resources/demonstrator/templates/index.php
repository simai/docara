...
<?php foreach ($view->items as $item) { ?>
        <article class="surface-0 border border-outline-variant radius-2 p-2 flex min-w-0 flex-col gap-1">
            ...
            <a class="sf-button sf-button--outline sf-button--primary sf-button--size-1 radius-default decoration-none inline-flex self-start m-top-auto items-center content-main-center" href="<?= $item->url ?>"><span class="sf-button-text-container"><?= $view->openLabel ?></span></a>
        </article>
<?php } ?>
    </div>
</div>
