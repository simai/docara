...
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("418f8022685b");
/* harmony import */ var lit_directives_ref_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("31aa3e3f11ff");
...
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("418f8022685b");
/* harmony import */ var _list_item_js_templates_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("fb74bd29f4bd");
...
function renderTag(context, option) {
  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
    ...
    >
      ${option.type === "color" ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="sf-tag-color-icon ${option.colorClass}"></span>` : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
      ${option.type === "icon" ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<i class="sf-icon sf-tag-icon">${option.icon}</i>` : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
      ...
      <button
        type="button"
        class="sf-icon-button sf-icon-button--link radius-default sf-icon-button--on-surface sf-icon-button--size-1/3"
...
function renderDropdownTemplate(context) {
  const rootClasses = ["sf-dropdown", context.open ? "open" : "", context.open ? "sf-dropdown--open" : "", `sf-dropdown--size-${context.size}`, `sf-dropdown--${context.type}`, context.mode === "tag" ? "sf-dropdown--tag" : "", context.mode !== "tag" ? "sf-dropdown--text" : "", context.disabled ? "disabled" : "", "flex", "flex-col"].filter(Boolean);
    ...
    if (context.mode === "tag") {
      return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
        ...
        >
          ...
          <button
            type="button"
            class="sf-icon-button sf-icon-button--on-surface sf-icon-button--link sf-icon-button--size-${iconButtonSize} radius-default absolute"
            ?disabled=${context.disabled}
          >
            <i class="sf-icon">${dropdownIcon}</i>
          </button>
        </div>
      `;
    }
    ...
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
      ...
      >
        ...
        <input
          ...
          name="dropdown_input_${context.size}"
        ...
        <button
          type="button"
          class="sf-icon-button sf-icon-button--icon sf-icon-button--on-surface sf-icon-button--link sf-icon-button--size-${iconButtonSize} radius-default absolute"
          ?disabled=${context.disabled}
        >
          <i class="sf-icon">${dropdownIcon}</i>
        </button>
...
function renderListItemTemplate(context) {
  ...
  const classes = ["sf-list-item", "cursor-pointer", "flex", "items-cross-center", `sf-list-item--${context.type}`, `sf-list-item--size-${context.size}`, "transition", context.selected ? "selected" : "", context.disabled ? "disabled" : ""].filter(Boolean);
  ...
  const renderLeading = () => {
    ...
    if (context.type === "icon") {
      return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<i class="sf-icon">${context.icon}</i>`;
    }
  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
    <div
      ...
      data-value=${context.value || lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
      aria-label=${context.ariaLabel || lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
      aria-disabled=${context.disabled ? "true" : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
      aria-selected=${context.selected ? "true" : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
    >
...
/* harmony export */ });
/* harmony import */ var _css_tag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("e40f73650005");
...
/* harmony export */ });
/* harmony import */ var _lit_reactive_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("6be601642b7d");
/* harmony import */ var lit_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("3e9ff08242d2");
...
/* harmony export */   directive: () => (/* reexport safe */ _directive_js__WEBPACK_IMPORTED_MODULE_1__.directive)
/* harmony export */ });
/* harmony import */ var _directive_helpers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("ff5dfcf755ad");
/* harmony import */ var _directive_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("f6e84642ecbb");
...
/* harmony export */ });
/* harmony import */ var _lit_html_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("3e9ff08242d2");
...
/* harmony export */ });
/* harmony import */ var _lit_html_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("3e9ff08242d2");
/* harmony import */ var _async_directive_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("6183aef782b4");
/* harmony import */ var _directive_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("f6e84642ecbb");
...
/* harmony export */ });
/* harmony import */ var lit_html_directives_ref_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("3727cc390f3f");
...
/* harmony import */ var _lit_reactive_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("6be601642b7d");
/* harmony import */ var lit_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("3e9ff08242d2");
/* harmony import */ var lit_element_lit_element_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("1ca4e97fedbf");
/* harmony import */ var lit_html_is_server_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("9abb11175a9b");
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("5affb433924b");
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("0d442d3e9b0b");
...
class SfDropdown extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  get selectedValues() {
    const attrValues = splitValues(this.selectedValue);
    return attrValues.length ? attrValues : this._selectedValues;
  }
  ...
  get triggerText() {
    ...
    return getOptionLabel(this.selectedOptions[0]) || '';
  }
  ...
  afterRender() {
    this._dropdownRoot = this.querySelector('.sf-dropdown');
  ...
  handleOptionClick(event) {
    ...
    if (!item || !this.contains(item) || item.classList.contains('disabled')) {
      return;
    }
  ...
  positionPortalList() {
    if (!this._list || !this._dropdownRoot || !this.portal) {
      return;
    }
    ...
    const field = this._dropdownRoot.querySelector('.sf-dropdown-field');
    ...
    const offset = 4;
    const listHeight = this._list.getBoundingClientRect().height || 0;
    ...
    this._dropdownRoot.dataset.placement = openAbove ? 'top' : 'bottom';

    this._dropdownRoot.classList.toggle('sf-dropdown--drop-up', openAbove);

    this._dropdownRoot.classList.toggle('sf-dropdown--drop-down', !openAbove);
  }
