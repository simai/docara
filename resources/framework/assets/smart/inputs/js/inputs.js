...
/* harmony export */ });
/* harmony import */ var _core_js_ComponentObserver__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c16986bba8f3");
/* harmony import */ var _register_helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("abe796898dab");
...
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("418f8022685b");
/* harmony import */ var _default_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("5689a9ec8c5e");
...
function renderInputTemplate(context) {
  ...
  const rootClasses = ['sf-input', error ? 'error' : '', `sf-input--size-${size}`, `sf-input--${type}`, rootClass, 'flex', 'flex-col'];
  ...
  const labelContent = context.component?.hasSlotContent?.('label') ? context.component.getSlotContent('label') : label ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
          ...
          ` : required ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="sf-input-required">*</span>` : '';
  const leftContent = context.component?.hasSlotContent?.('left') ? context.component.getSlotContent('left') : leftIcon ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="sf-input-left flex"><sf-icon icon="${leftIcon}"></sf-icon></span>` : '';
  const rightContent = context.component?.hasSlotContent?.('right') ? context.component.getSlotContent('right') : (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
    ...
    >
      ...
      ${hintContent ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="sf-input-hint-text-wrap">${hintContent}</span>` : ''}
    </label>
  `;
}
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _component_inputs_js_inputs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("ee8ac86eb4d8");
/* harmony import */ var _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("5affb433924b");
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("cda5cdcfdd59");
...
class SfInput extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  get state() {
    ...
    return {
      ...
      error: input?.classList?.contains('error') || false
    };
  }
