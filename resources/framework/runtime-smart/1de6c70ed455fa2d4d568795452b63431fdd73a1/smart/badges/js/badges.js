...
function renderBadgeTemplate(context) {
  ...
  const leftIconContent = context.component?.hasSlotContent?.('icon-left') ? context.component.getSlotContent('icon-left') : createIcon(leftIconName);
  const rightIconContent = context.component?.hasSlotContent?.('icon-right') ? context.component.getSlotContent('icon-right') : createIcon(rightIconName);
