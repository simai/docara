...
function renderCloseTemplate(context) {
  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="${classes}" style=${context.rootStyle || lit__WEBPACK_IMPORTED_MODULE_0__.nothing} aria-hidden="true"><span class="sf-close-icon"></span></span>`;
}
...
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("dc0533243b98");
...
class SfClose extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static get props() {
    return {
      size: {
        default: '1/3',
        values: ['1/4', '1/3', '1/2', '1', '2', '3', '4', '5', '6', '7']
      },
      rootClass: {
        default: ''
      }
