...
const COMPONENT_ATTRIBUTES = new Set(['template', 'variant', 'size', 'type', 'scheme', 'icon', 'filled', 'tightness', 'radius', 'segment', 'root-class', 'loading', 'disabled', 'native-type', 'aria-label', 'class', 'style', 'id', 'slot']);
