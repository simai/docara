    ...
    >
      ...
      ${context.middle ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
            <div class=${mainClasses}>
              ...
              ${context.total > 0 ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
              ...
              ${context.showPageSize && context.total > 0 ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
...
class SfPagination extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  get selectedCount() {
    ...
    return Number.isFinite(parsed) ? Math.min(Math.max(parsed, 0), this.total) : 0;
  }
