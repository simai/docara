...
function renderProgressScaleTemplate(context) {
  ...
  const rootClasses = ['sf-progress-scale', `sf-progress-scale--size-${size}`, `sf-progress-scale--${tone}`, 'flex', 'flex-col', context.rootClass].filter(Boolean);
  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
    ...
    length: 10
      ...
      ${context.showText ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<div class="sf-progress-scale-text">${value}%</div>` : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
    </div>
  `;
}
...
/* harmony import */ var _component_progress_scale_js_progress_scale__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("736e917526e6");
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("f65a1c6fa30a");
...
class SfProgressScale extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  template() {
    return (0,_js_templates_default__WEBPACK_IMPORTED_MODULE_2__.renderProgressScaleTemplate)(this.templateContext());
  }
  ...
  resolveUpdateMode(changedAttributes = []) {
    const directPatchAttributes = ['value', 'show-text', 'tone', 'label', 'value-text'];
  ...
  updateDom() {
    ...
    if (!root) return false;
    return (0,_component_progress_scale_js_progress_scale__WEBPACK_IMPORTED_MODULE_1__.setProgressScaleState)(root, {
      value: this.value,
      showText: this.showText,
      tone: this.tone,
      label: this.label,
