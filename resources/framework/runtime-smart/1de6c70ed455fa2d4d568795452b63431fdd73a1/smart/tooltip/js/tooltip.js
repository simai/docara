...
function tailTemplate(context) {
  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<div class="sf-tooltip-tail" aria-hidden="true"></div>`;
}

function renderTooltipTemplate(context) {
  const classes = ['sf-tooltip', `sf-tooltip--${context.type}`, `sf-tooltip--arrow-${context.arrow}`, `sf-tooltip--size-${context.size}`, 'relative', context.rootClass].filter(Boolean);
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
    <div class=${classes.join(' ')} style=${context.rootStyle || lit__WEBPACK_IMPORTED_MODULE_0__.nothing}>
...
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("6d8735a1253b");
