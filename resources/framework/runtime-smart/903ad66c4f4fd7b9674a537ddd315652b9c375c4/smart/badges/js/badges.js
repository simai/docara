...
function renderBadgeTemplate(context) {
  ...
  const classes = ['sf-badge', `sf-badge--${context.type}`, `sf-badge--${context.scheme}`, `sf-badge--size-${context.size}`, 'flex', 'flex-row', 'flex-nowrap', 'justify-center', 'items-center', context.rootClass].filter(Boolean);
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
    <span
      class=${classes.join(' ')}
      style=${context.rootStyle || lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
      aria-hidden=${!hasTextContent && !hasAccessibleLabel ? 'true' : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
    >
      ${hasAccessibleLabel ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="sr-only">${context.ariaLabel}</span>` : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
      ${leftIconContent}
      ${hasTextContent ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
            <span
              class="sf-badge-text-container flex items-center"
              aria-hidden=${hasAccessibleLabel ? 'true' : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
            >
...
/* harmony import */ var _component_badges_js_contract__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("a2a9d3c2841e");
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("fa5e5692ffca");




class SfBadge extends _core_js_smart_base__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static get props() {
    return {
      templateName: {
        attribute: 'template',
