...
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");
/* harmony import */ var _helpers_text__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("5e52138e113a");
...
function renderAdminMenuTemplate(context) {
  ...
  function renderItemContent(item, trailing = lit__WEBPACK_IMPORTED_MODULE_0__.nothing, showSettings = false) {
    return !context.compact ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
          ...
          >
            ${item.iconStart ? renderIcon(item.iconStart) : item.placeholder ? renderPlaceholder(item.label) : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
            <span class="overflow-hidden whitespace-nowrap t-ellipsis"
              >${item.label}</span
            >
          </span>
          ${showSettings ? lit__WEBPACK_IMPORTED_MODULE_0__.nothing : (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`${item.iconEnd ? renderIcon(item.iconEnd) : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
                ${item.badge ? renderBadge(item) : lit__WEBPACK_IMPORTED_MODULE_0__.nothing} ${trailing}`}
  ...
  function renderSearchResult(item) {
    const content = (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
      ...
      ${item.iconEnd ? renderIcon(item.iconEnd) : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
...
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("992cb12ac0ed");
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("c06304d43762");
/* harmony import */ var _helpers_dom__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("30bb289e6995");
/* harmony import */ var _helpers_draggable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("09c312a7a6df");
...
class SfAdminMenu extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static get props() {
    return {
      templateName: {
        attribute: "template",
  ...
  itemNodeToData(node, path = []) {
    ...
    const data = {
      type,
      label,
      iconStart: node.getAttribute("icon-start") || node.getAttribute("left-icon") || "",
      iconEnd: node.getAttribute("icon-end") || node.getAttribute("right-icon") || "",
  ...
  externalNodeToData(node = {}, sourceIndex = 0) {
    ...
    const item = {
      ...
      iconStart: String(node.iconStart || node.icon || ""),
      iconEnd: String(node.iconEnd || ""),
  ...
  clampContextMenuToViewport() {
    ...
    if (anchor && (!anchor.position || /^(left|right)(-top|-bottom)?$/.test(anchor.position))) {
      ...
      const shift = anchor.transform === undefined ? alignment : Number(anchor.transform) / 100;
