...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderBadgeTemplate: () => (/* binding */ renderBadgeTemplate)
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");
...
function renderBadgeTemplate(context) {
  ...
  const leftIconContent = context.component?.hasSlotContent?.('icon-start') ? context.component.getSlotContent('icon-start') : context.component?.hasSlotContent?.('icon-left') ? context.component.getSlotContent('icon-left') : createIcon(leftIconName);
  const rightIconContent = context.component?.hasSlotContent?.('icon-end') ? context.component.getSlotContent('icon-end') : context.component?.hasSlotContent?.('icon-right') ? context.component.getSlotContent('icon-right') : createIcon(rightIconName);
  const hasTextSlot = context.component?.hasSlotContent?.('text');
  const hasTextContent = hasTextSlot || String(context.text ?? '').length > 0;
  const textContent = hasTextSlot ? context.component.getSlotContent('text') : context.text;
  const classes = ['sf-badge', `sf-badge--${context.type}`, `sf-badge--${context.scheme}`, `sf-badge--size-${context.size}`, 'flex', 'flex-row', 'flex-nowrap', 'justify-center', 'items-center'].filter(Boolean);
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
    <div class=${classes.join(' ')} aria-label=${context.ariaLabel || lit__WEBPACK_IMPORTED_MODULE_0__.nothing}>
      ${leftIconContent}
      ${hasTextContent ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
...
/* harmony import */ var _component_badges_js_contract__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("7f5153446ab9");
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("aa586e348f27");




class SfBadge extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static get props() {
    return {
      templateName: {
        attribute: 'template',
      ...
      size: {
        default: '1/3',
        values: _component_badges_js_contract__WEBPACK_IMPORTED_MODULE_1__.BADGE_SIZES
      },
      type: {
        default: 'main',
        values: _component_badges_js_contract__WEBPACK_IMPORTED_MODULE_1__.BADGE_TYPES
      },
      scheme: {
        default: 'neutral',
        values: _component_badges_js_contract__WEBPACK_IMPORTED_MODULE_1__.BADGE_SCHEMES
      },
      text: {
        default: ''
      },
  ...
  get size() {
    return this.getEnumAttr('size', _component_badges_js_contract__WEBPACK_IMPORTED_MODULE_1__.BADGE_SIZES, '1/3');
  }

  get type() {
    return (0,_component_badges_js_contract__WEBPACK_IMPORTED_MODULE_1__.normalizeBadgeContract)({
      type: this.getEnumAttr('type', _component_badges_js_contract__WEBPACK_IMPORTED_MODULE_1__.BADGE_TYPES, 'main'),
      scheme: this.getEnumAttr('scheme', _component_badges_js_contract__WEBPACK_IMPORTED_MODULE_1__.BADGE_SCHEMES, 'neutral'),
      size: this.getEnumAttr('size', _component_badges_js_contract__WEBPACK_IMPORTED_MODULE_1__.BADGE_SIZES, '1/3')
    }).type;
  }

  get scheme() {
    return this.getEnumAttr('scheme', _component_badges_js_contract__WEBPACK_IMPORTED_MODULE_1__.BADGE_SCHEMES, 'neutral');
  }
  ...
  templateContext() {
    ...
    const variant = (0,_component_badges_js_contract__WEBPACK_IMPORTED_MODULE_1__.normalizeBadgeContract)(props);
  ...
  template() {
    return (0,_js_templates_default__WEBPACK_IMPORTED_MODULE_2__.renderBadgeTemplate)(this.templateContext());
  }

  resolveUpdateMode(changedAttributes = []) {
    const directPatchAttributes = ['aria-label'];
  ...
  updateDom(changedAttributes = []) {
    const badge = this.querySelector('.sf-badge');
    ...
    if (changedAttributes.includes('text')) {
      const textNode = badge.querySelector('.sf-badge-text');
