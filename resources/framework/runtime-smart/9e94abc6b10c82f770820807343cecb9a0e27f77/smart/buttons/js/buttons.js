...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderButtonTemplate: () => (/* binding */ renderButtonTemplate)
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");

function renderButtonTemplate(context) {
  const {
    size,
    type,
    scheme,
  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
        ...
        >
            ${leftIconContent}
            ${textContent ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span
...
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("a57193d5d4a4");
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("c06304d43762");
/* harmony import */ var _cl_classes_template_controlSpacing__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("8fd843bdb9e7");
...
function applyButtonAttributes(host, button) {
  host?.forwardHostAttributes(button, {
    ...
    transferDataAttributes: true,
    storageKey: "__sfButtonForwardedDataAttributes",
    targetStorageKey: "__sfButtonAttributeKeys"
  });
}

class SfButton extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  ...
  template() {
    return (0,_js_templates_default__WEBPACK_IMPORTED_MODULE_1__.renderButtonTemplate)(this.templateContext());
  }
  ...
  afterRender() {
    ...
    if (!this._attributeObserver) {
      this._attributeObserver = this.observeForwardedHostAttributes(() => this.querySelector(".sf-button"), {
        exclude: COMPONENT_ATTRIBUTES,
        transferDataAttributes: true,
        storageKey: "__sfButtonForwardedDataAttributes",
        targetStorageKey: "__sfButtonAttributeKeys"
  ...
  createIcon(name) {
    if (!name) return "";
    return (0,lit__WEBPACK_IMPORTED_MODULE_2__.html)`<sf-icon icon="${name}" root-class="pointer-event-none" weight="400"></sf-icon>`;
  }
