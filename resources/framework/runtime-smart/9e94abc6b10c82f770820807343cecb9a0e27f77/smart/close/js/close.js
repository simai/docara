...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderCloseTemplate: () => (/* binding */ renderCloseTemplate)
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");

function renderCloseTemplate(context) {
  const classes = ['sf-close', `sf-close--size-${context.size || '1/3'}`, 'flex', 'justify-center', 'items-center', context.rootClass].filter(Boolean).join(' ');
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="${classes}"><span class="sf-close-icon"></span></span>`;
}
...
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("b03c9a217d5d");



class SfClose extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static get props() {
    return {
      size: {
        default: '1/3'
  ...
  get size() {
    return this.getAttribute('size') || '1/3';
  }
  ...
  template() {
    return (0,_js_templates_default__WEBPACK_IMPORTED_MODULE_1__.renderCloseTemplate)(this.templateContext());
  }

}

SfClose.define('sf-close');
})();
