...
/* harmony import */ var _json_country_code_utility_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("feb014b8e066");
/* harmony import */ var _data_countries_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("805c4af1301c");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderCountryCodeTemplate: () => (/* binding */ renderCountryCodeTemplate)
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");
...
function flagTemplate(country, flagBase = '') {
  ...
  if (!src) {
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`${fallback}`;
  }
...
function renderCountryCodeTemplate(context) {
  const {
    size,
    label,
    required,
  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
    ...
    >
      <span class="sf-country-code-label flex">
        ...
        ${required ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="sf-country-code-required">*</span>` : ''}
      </span>
      ...
      <span class="sf-country-code-field transition flex items-center">
        <span class="sf-country-code-left flex items-center">
          ...
          ${multiCountry ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<i class="sf-icon">${open ? 'expand_less' : 'expand_more'}</i>` : ''}
        </span>
        <input
          type="text"
          .value=${value}
      ...
      ${multiCountry ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
            <span class="sf-country-code-list">
              <span class="sf-country-code-items flex flex-col">
                ${countries.map(country => (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
                    <span
                    ...
                    >
                      ...
                      <span>
                        ${country.label || `${locale === 'en' ? country.nameEn : country.nameRu || country.nameEn} (${country.dialCode || country.code || ''})`}
                      </span>
                    </span>
                  `)}
              </span>
      ...
      ${hint ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="sf-country-code-hint">${hint}</span>` : ''}
    </label>
  `;
}
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _component_country_code_data_countries_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("805c4af1301c");
/* harmony import */ var _component_country_code_js_country_code__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("e748d97af759");
/* harmony import */ var _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("dd9ac7709472");
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("4fd96e303251");




const COUNTRY_CODE_SELECTOR = '.sf-country-code';
const COUNTRY_ITEMS = Array.isArray(_component_country_code_data_countries_json__WEBPACK_IMPORTED_MODULE_0__?.items) ? _component_country_code_data_countries_json__WEBPACK_IMPORTED_MODULE_0__.items : [];

class SfCountryCode extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_2__["default"] {
  static get props() {
    return {
      size: {
        default: '1'
  ...
  get placeholder() {
    return this.getAttribute('placeholder') || '+7(___)___-__-__';
  }
  ...
  get open() {
    return this.getBooleanAttr('open', false) || this.getBooleanAttr('active', false);
  }

  get locale() {
    return String(this.getAttribute('locale') || 'ru').toLowerCase() === 'en' ? 'en' : 'ru';
  }

  get useMask() {
    return this.getBooleanAttr('use-mask', false);
  }

  get useCountryMasks() {
    return this.getBooleanAttr('use-country-masks', true);
  }

  get showCode() {
    return this.getBooleanAttr('show-code', true);
  }

  get maskStyle() {
    return String(this.getAttribute('mask-style') || 'native').toLowerCase() === 'brackets' ? 'brackets' : 'native';
  }

  get multiCountry() {
    return this.getBooleanAttr('multi-country', true);
  }

  get iso2() {
    return (0,_component_country_code_js_country_code__WEBPACK_IMPORTED_MODULE_1__.normalizeIso2)(this.getAttribute('iso2'));
  }

  get dialCode() {
    return String(this.getAttribute('dial-code') || '').trim();
  }

  get maskPattern() {
    return String(this.getAttribute('mask-pattern') || '').trim();
  }

  get flagBase() {
    return String(this.getAttribute('flag-base') || '').trim() || (0,_component_country_code_js_country_code__WEBPACK_IMPORTED_MODULE_1__.resolveDefaultFlagBase)();
  }

  get lazyFlags() {
    return this.getBooleanAttr('lazy-flags', true);
  }

  get showMaskPlaceholder() {
    return this.getBooleanAttr('show-mask-placeholder', false);
  }

  get maskPlaceholderChar() {
    return String(this.getAttribute('mask-placeholder-char') || '_');
  }

  get maxItems() {
    return Math.trunc(this.getNumberAttr('max-items', 0));
  }

  get countries() {
    return (0,_component_country_code_js_country_code__WEBPACK_IMPORTED_MODULE_1__.normalizeCountriesList)(this._countries, this.locale, this.maxItems);
  }

  set countries(value) {
    this._countries = Array.isArray(value) ? value : null;
    this.requestComponentUpdate('countries');
  }
  ...
  templateContext() {
    ...
    return this.createTemplateContext({ ...props,
      open: this.open,
      countries: this.countries.length ? this.countries : (0,_component_country_code_js_country_code__WEBPACK_IMPORTED_MODULE_1__.normalizeCountriesList)(COUNTRY_ITEMS, this.locale, this.maxItems),
      locale: this.locale,
  ...
  onDisconnected() {
    if (this._boundRoot) {
      (0,_component_country_code_js_country_code__WEBPACK_IMPORTED_MODULE_1__.unbindCountryCode)(this._boundRoot);
      this._boundRoot = null;
    }
  }
  ...
  afterRender() {
    ...
    this._boundRoot = this.querySelector(COUNTRY_CODE_SELECTOR);

    if (this._boundRoot) {
      (0,_component_country_code_js_country_code__WEBPACK_IMPORTED_MODULE_1__.bindCountryCode)(this._boundRoot);
    }
  }

  template() {
    return (0,_js_templates_default__WEBPACK_IMPORTED_MODULE_3__.renderCountryCodeTemplate)(this.templateContext());
  }

  get state() {
    const root = this.querySelector(COUNTRY_CODE_SELECTOR);
    const input = root?.querySelector?.('.sf-country-code-field input') || null;
    return {
      value: input?.value || '',
      iso2: root?.dataset?.iso2 || '',
      dialCode: root?.dataset?.dialCode || '',
      open: root?.classList?.contains('open') || false,
      disabled: root?.classList?.contains('disabled') || false
    };
  }

  setState(nextState = {}) {
    const root = this.querySelector(COUNTRY_CODE_SELECTOR);
    return (0,_component_country_code_js_country_code__WEBPACK_IMPORTED_MODULE_1__.setCountryCodeState)(root, nextState);
  }

}

SfCountryCode.define('sf-country-code');
})();
