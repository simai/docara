  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
        <div class="sf-datepicker-context absolute top-0 bottom-0 inline-start-0 inline-end-0 grid grid-col-3 content-cross-start items-cross-start z-2 overflow-auto gap-1/4">
            ${context.months.map(month => (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
                <button
                        class=${joinClasses('sf-datepicker-text flex content-main-center items-cross-center', month.selected ? 'active' : '', month.disabled ? 'disabled' : '')}
  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
        <div class="sf-datepicker-context absolute top-0 bottom-0 inline-start-0 inline-end-0 grid grid-col-3 content-cross-start items-cross-start z-2 overflow-auto gap-1/4">
            ${context.years.map(year => (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
                <button
                        class=${joinClasses('sf-datepicker-text flex content-main-center items-cross-center', year.selected ? 'active' : '', year.disabled ? 'disabled' : '')}
                        type="button"
...
function renderDatepickerInput(context) {
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
        <sf-input
                ...
                name=${context.inputName || lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
                placeholder=${context.placeholder || lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
                icon-start=${context.iconStart ?? context.leftIcon ?? lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
                root-class=${context.inputRootClass || lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
                value=${context.displayValue || ''}
                ?mask=${context.mask}
                mask-pattern=${context.maskPattern || lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
                ...
                mask-options=${context.maskOptions || lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
                readonly
...
function renderDatepickerTemplate(context) {
  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
        <div
                class=${joinClasses('sf-datepicker-wrap inline-flex flex-col relative', context.open ? 'is-open' : '', state ? 'sf-datepicker-wrap--drop-up' : 'sf-datepicker-wrap--drop-down')}
...
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("6dc831d66f0c");
...
function normalizeMonth(value, fallback = 0) {
  const month = (0,_cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__.toNumber)(value, fallback);
...
class SfDatepicker extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._input = null;
  ...
  get mask() {
    return this.getBooleanAttr('mask', true);
  }
  ...
  set year(nextValue) {
    this.setState({
      year: nextValue === null || typeof nextValue === 'undefined' || nextValue === '' ? '' : String((0,_cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__.toNumber)(nextValue, new Date().getFullYear()))
    });
  }
  ...
  getYearPageStart(year = this.year) {
    const normalizedYear = (0,_cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__.toNumber)(year, new Date().getFullYear());
  ...
  positionPanel() {
    ...
    const top = openAbove ? Math.max(viewportMargin, rect.top - panelHeight - offset) : rect.bottom + offset;
  ...
  afterRender() {
    this._input = this.refs.input?.value?.querySelector('.sf-input') || null;
