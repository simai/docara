...
/* harmony import */ var _json_download_file_utility_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("29185f3accc0");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderDownloadFileTemplate: () => (/* binding */ renderDownloadFileTemplate)
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");

function renderDownloadFileTemplate(context) {
  const {
    size,
    fileName,
    fileSize,
  ...
  const rootClasses = ['sf-download-file', `sf-download-file--size-${size}`, disabled ? 'disabled' : 'cursor-pointer transition'].filter(Boolean);
  ...
  if (tagName === 'a') {
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
      <a
        ...
        href=${href}
        target=${download ? lit__WEBPACK_IMPORTED_MODULE_0__.nothing : target}
        rel=${download ? lit__WEBPACK_IMPORTED_MODULE_0__.nothing : 'noopener noreferrer'}
        download=${download ? fileName || '' : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
    <button
      ...
      class=${rootClasses.join(' ')}
      ?disabled=${disabled}
      aria-disabled=${disabled ? 'true' : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
      aria-label=${ariaLabel || lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
    >
      ${content}
    </button>
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _component_download_file_js_download_file__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("55e94dd2ff88");
/* harmony import */ var _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("dd9ac7709472");
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("b30abb4628a4");




class SfDownloadFile extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_1__["default"] {
  static get props() {
    return {
      templateName: {
        attribute: 'template',
  ...
  get fileName() {
    return this.getAttribute('file-name') || 'File.pdf';
  }
  ...
  get icon() {
    return this.getAttribute('icon') || 'download';
  }
  ...
  get download() {
    return this.getBooleanAttr('download', false);
  }
  ...
  template() {
    return (0,_js_templates_default__WEBPACK_IMPORTED_MODULE_2__.renderDownloadFileTemplate)(this.templateContext());
  }

  afterRender() {
    if (this._boundRoot) {
      (0,_component_download_file_js_download_file__WEBPACK_IMPORTED_MODULE_0__.unbindDownloadFile)(this._boundRoot);
      this._boundRoot = null;
    }

    this._boundRoot = this.querySelector('.sf-download-file');

    if (this._boundRoot) {
      (0,_component_download_file_js_download_file__WEBPACK_IMPORTED_MODULE_0__.bindDownloadFile)(this._boundRoot);
    }
  }
...
SfDownloadFile.define('sf-download-file');
})();
