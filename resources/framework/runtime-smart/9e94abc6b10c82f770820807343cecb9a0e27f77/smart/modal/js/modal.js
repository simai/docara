            ...
            >
                ...
                >
                    ${showHeader ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
                                ...
                                >
                                    ${hasHeaderSlot ? context.headerContent : (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<h2 id=${titleId} class="title-3 m-0">${context.title}</h2>`}
...
/* harmony export */ });
/* harmony import */ var lit_html_directives_unsafe_html_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("84ba3368389f");
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");
/* harmony import */ var lit_directives_unsafe_html_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("065107589ede");
/* harmony import */ var _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("dd9ac7709472");
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("9a838731cd1a");
...
class SfModal extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_2__["default"] {
    ...
    if (this.mode === "iframe" && this.src) {
      return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
        <iframe
          ...
          allowfullscreen
          style="min-height:calc(var(--sf-g2) + var(--sf-b6));height:100%;"
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    ...
    if (name === "open" && oldValue !== newValue) {
      ...
      if (newValue === null) {
        this.close(); // close() can be a no-op after detach or before an async render commits.
        // The removed attribute still invalidates that render's open snapshot.
