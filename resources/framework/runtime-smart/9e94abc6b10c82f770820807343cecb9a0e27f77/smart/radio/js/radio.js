...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderRadioTemplate: () => (/* binding */ renderRadioTemplate)
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");

function renderRadioTemplate(context) {
  const {
    size,
    label,
    description,
  ...
  const labelContent = context.component?.hasSlotContent?.('label') ? context.component.getSlotContent('label') : label ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="sf-radio-button-text">${label}</span>` : '';
  const descriptionContent = context.component?.hasSlotContent?.('description') ? context.component.getSlotContent('description') : description ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="sf-radio-button-description">${description}</span>` : '';
  const helpContent = context.component?.hasSlotContent?.('help') ? context.component.getSlotContent('help') : help ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<i class="sf-icon" aria-hidden="true">${help}</i>` : '';
...
/* harmony import */ var _component_radio_js_radio__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("ae0f6b0cc81f");
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("9307bd138de4");




function syncSmartRadioGroupByName(name = '') {
  if (!name) return;
  document.querySelectorAll('sf-radio').forEach(component => {
...
class SfRadio extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static get props() {
    return {
      size: {
        default: '1'
  ...
  template() {
    return (0,_js_templates_default__WEBPACK_IMPORTED_MODULE_2__.renderRadioTemplate)(this.templateContext());
  }

  afterRender() {
    if (this._boundRoot) {
      (0,_component_radio_js_radio__WEBPACK_IMPORTED_MODULE_1__.unbindRadio)(this._boundRoot);
      this._boundRoot = null;
    }

    this._boundRoot = this.querySelector('.sf-radio-button');

    if (this._boundRoot) {
      (0,_component_radio_js_radio__WEBPACK_IMPORTED_MODULE_1__.bindRadio)(this._boundRoot);
      const input = this.getInputElement();

      if (input) {
        (0,_component_radio_js_radio__WEBPACK_IMPORTED_MODULE_1__.setRadioState)(input, {
  ...
  _handleChange = () => {
    ...
    syncSmartRadioGroupByName(input.name);
  };

  getInputElement() {
    return this.querySelector('.sf-radio-button input[type="radio"]');
  }
  ...
  setState(nextState = {}) {
    ...
    (0,_component_radio_js_radio__WEBPACK_IMPORTED_MODULE_1__.setRadioState)(input, nextState);
