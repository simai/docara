...
/* harmony export */ });
/* harmony import */ var nouislider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("65797fc90207");
...
function renderRangeSliderTemplate(context) {
  const rootClasses = joinClasses('sf-range-slider', 'flex-1', context.rootClass, context.label === 'tooltip' ? 'p-top-4' : '', context.disabled ? 'disabled' : '');
...
/* harmony import */ var _component_range_slider_js_range_slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("a73f05dad29d");
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("a1f48141aec7");
/* harmony import */ var _helpers_loaderDragState__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("cfd97541c65b");
...
class SfRangeSlider extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  resolveUpdateMode(changedAttributes = []) {
    ...
    const requiresRerender = changedAttributes.some(name => ['template', 'connected', 'min', 'max', 'start', 'multiple', 'step', 'margin', 'connect', 'keyboard', 'label', 'prefix', 'suffix', 'decimals', 'tooltip-position', 'text-position', 'label-position', 'root-class'].includes(name));
  ...
  afterRender() {
    ...
    if (this._boundRoot) {
      (0,_component_range_slider_js_range_slider__WEBPACK_IMPORTED_MODULE_1__.bindRangeSlider)(this._boundRoot);
  ...
  setValue(nextValue) {
    ...
    if (this.shouldRebuildForValue(nextValue)) {
      this.setAttribute('value', serialized);
      return this;
    }
