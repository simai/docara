...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderReferenceLinkTemplate: () => (/* binding */ renderReferenceLinkTemplate)
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");

function renderReferenceLinkTemplate(context) {
  const {
    component,
    icon,
    label,
  ...
  const rootClasses = ['sf-reference-link', 'flex', 'items-cross-center', disabled ? 'disabled' : '', rootClass].filter(Boolean).join(' ');
  const labelContent = component?.hasSlotContent?.('label') ? component.getSlotContent('label') : label;
  const textContent = component?.hasSlotContent?.('text') ? component.getSlotContent('text') : text;
  const linkContent = href && !disabled ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
          <a
            href=${href}
            target=${target || lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
            rel=${target && target !== '_self' ? 'noopener noreferrer' : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
            aria-label=${ariaLabel || lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
          >
            ${labelContent}
          </a>
        ` : (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span>${labelContent}</span>`;
...
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("db3108588025");



class SfReferenceLink extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static get props() {
    return {
      templateName: {
        attribute: 'template',
  ...
  get icon() {
    return this.getAttribute('icon') || 'arrow_forward';
  }
  ...
  template() {
    return (0,_js_templates_default__WEBPACK_IMPORTED_MODULE_1__.renderReferenceLinkTemplate)(this.templateContext());
  }
...
SfReferenceLink.define('sf-reference-link');
})();
