...
/* harmony export */ });
/* harmony import */ var _loaderDragState__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("cfd97541c65b");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   tableSmartElement: () => (/* binding */ tableSmartElement)
/* harmony export */ });
/* harmony import */ var lit_async_directive_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("b3c0450d7aee");
/* harmony import */ var _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("dd9ac7709472");

 // Identity belongs to the Lit child part, not to each table render.

class TableSmartElement extends lit_async_directive_js__WEBPACK_IMPORTED_MODULE_0__.AsyncDirective {
  render(type, props = {}) {
    const tag = String(type || '').startsWith('sf-') ? String(type) : `sf-${String(type || '')}`;
    if (!/^sf-[a-z0-9-]+$/.test(tag)) throw new Error(`Invalid SF tag name: ${tag}`);
    ...
    for (const [key, value] of Object.entries(props || {})) {
      if (key === ':key' || key === ':ref' || value == null) continue;
      ...
      if (key.startsWith('@') && typeof value === 'function') {
        ...
        next.set(key, {
          kind: typeof value === 'object' || typeof value === 'function' ? 'property' : 'attribute',
          name: typeof value === 'object' || typeof value === 'function' ? key : (0,_cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_1__.toAttributeName)(key),
          value
        });
      }
    }
    ...
    for (const [key, old] of this.bindings) {
      ...
      if (!current || current.kind !== old.kind || current.value !== old.value) this.remove(old);
    }

    for (const [key, current] of next) {
      const old = this.bindings.get(key);
      if (!old || old.kind !== current.kind || old.value !== current.value) this.apply(current);
    }
    ...
    if (this.ref !== props?.[':ref']) {
      ...
      this.ref = props?.[':ref'];
      if (this.isConnected) this.setRef(this.element);
    }
  ...
  apply(binding) {
    ...
    if (kind === 'event') {
      if (this.isConnected) this.element.addEventListener(name, value);
    } else if (kind === 'property') this.element[name] = value;else if (typeof value === 'boolean') this.element.toggleAttribute(name, value);else if (this.element.getAttribute(name) !== String(value)) this.element.setAttribute(name, String(value));
  }
  ...
  remove({
    ...
    if (kind === 'event') this.element.removeEventListener(name, value);else if (kind === 'property') this.element[name] = undefined;else this.element.removeAttribute(name);
  }

  setRef(value) {
    if (typeof this.ref === 'function') this.ref(value);else if (this.ref && typeof this.ref === 'object' && (value || this.ref.value === this.element)) this.ref.value = value;
  }
  ...
  release() {
    ...
    for (const binding of this.bindings?.values() || []) {
      if (binding.kind === 'event') this.remove(binding);
    }
  }
  ...
  reconnected() {
    for (const binding of this.bindings?.values() || []) {
      if (binding.kind === 'event') this.apply(binding);
    }

    this.setRef(this.element);
  }

}

const tableSmartElement = (0,lit_async_directive_js__WEBPACK_IMPORTED_MODULE_0__.directive)(TableSmartElement);
...
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");
/* harmony import */ var lit_directives_keyed_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("b649b8c4691e");
/* harmony import */ var _default_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("34af26d1d416");
...
function renderToolbar(context) {
  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
        <div
                class="sf-table-toolbar flex${!searchActive ? ' items-cross-start' : ' gap-1/2'} content-main-between flex-none${searchActive && activeFilterTags.length ? ' flex-col-reverse' : ''}"
        >
            <div class="sf-table-toolbar-start flex items-cross-center gap-1/3 flex-wrap ${!activeFilterTags.length && searchActive ? 'hidden' : ''}">
        ...
        >
            ...
            <div class="table-wrap min-w-0 max-w-full flex flex-col flex-1 min-h-0">
                <div class="min-h-0 min-w-0 overflow-auto flex-1 relative m-bottom-2">
                    <table :ref=${context.component.refs.table} class="table border-separate border-spacing-0 min-w-full w-max table-fixed transition">
...
/* harmony import */ var _lit_html_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("b548f62420cb");
/* harmony import */ var _directive_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("307fed0f900b");
/* harmony import */ var _directive_helpers_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("49ee274d2e05");
...
/* harmony export */   directive: () => (/* reexport safe */ lit_html_async_directive_js__WEBPACK_IMPORTED_MODULE_0__.directive)
/* harmony export */ });
/* harmony import */ var lit_html_async_directive_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("68353248c045");
...
/* harmony export */ });
/* harmony import */ var lit_html_directives_keyed_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("506dd6b07666");
...
/* harmony import */ var _js_smart_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("87f1d68c3ef2");
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("8596962201c1");
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("c06304d43762");
/* harmony import */ var _helpers_dom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("30bb289e6995");
/* harmony import */ var _helpers_draggable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("09c312a7a6df");
/* harmony import */ var _helpers_loaderDragState__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("cfd97541c65b");
...
class SfTable extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static get props() {
    return {
      templateName: {
        attribute: "template",
  ...
  constructor() {
    ...
    this.TABLE_SETTINGS_COLUMN = {
      ...
      label: "settings",
      system: true,
      width: 'calc(var(--sf-text-height-1) + calc(var(--sf-ui-1--space-y-tightness-default) * 2) + var(--sf-b6))',
      component: {
        type: "icon-button",
        props: {
          size: "1",
    ...
    this.TABLE_SELECT_COLUMN = {
      ...
      label: "select",
      system: true,
      width: 'calc(var(--sf-text-height-1) + var(--sf-b6) + var(--sf-a2));',
      component: {
        type: "checkbox",
        props: {
          position: 'end',
  ...
  renderSmartElement(type, props = {}) {
    return (0,_js_smart_element__WEBPACK_IMPORTED_MODULE_1__.tableSmartElement)(type, props);
  }
  ...
  isContextMenuEvent(event) {
    ...
    const portal = this._tablePortal;
  ...
  contextEvent(event) {
    if (this.isContextMenuEvent(event)) {
      return;
    } // Dismissing a filter is cancellation, not an implicit draft save.
    // Do not clear drafts in closeContextMenu: internal menu transitions
    // also use that method and may intentionally carry pending settings.


    if (['tag-settings', 'filter-settings'].includes(this.state.contextMenu?.menu)) {
      this.tempSettings = null;
    }
  ...
  dispatchFilterTemplateSave(key, filter, template = null) {
    this.dispatchEvent(new CustomEvent("onTemplateSave", {
      bubbles: true,
      composed: true,
      detail: template || this.getFilterTemplateByKey(key, filter)
    }));
    return this;
  }
  ...
  dispatchFilterTemplatesSave(templates = []) {
    ...
    this.dispatchEvent(new CustomEvent("onTemplateSave", {
      bubbles: true,
      composed: true,
      detail: filteredTemplates.length === 1 ? filteredTemplates[0] : filteredTemplates
    }));
    return this;
  }
  ...
  bindFilterTemplateDrag() {
    ...
    container.querySelectorAll("[data-filter-template-key]").forEach(item => {
      ...
      (0,_helpers_draggable__WEBPACK_IMPORTED_MODULE_5__.bindSortableDrag)({
        handle,
        item,
        container,
    ...
    const {
      ...
      items = [{
        ...
        props: {
          type: "link",
          scheme: "on-surface",
          iconStart: `visibility${!tempVisible ? "_off" : ""}`,
  ...
  renderFilterOption(field = {}, option = {}, selected = new Set()) {
    ...
    return (0,lit__WEBPACK_IMPORTED_MODULE_3__.html)`
            <div
                    :ref=${this.getItemRef(option.label) || false}
  ...
  renderFilterSettingsContextMenu(data) {
    ...
    const sortTemplates = this.getSortedFilterTemplates(pendingFilter).map(col => {
      ...
      return (0,lit__WEBPACK_IMPORTED_MODULE_3__.html)`
                <div
                        :key=${col.key}
                        :ref=${this.getItemRef(col.label) || false}
  ...
  renderContextMenu(data) {
    if (!data?.open) {
      if (this._tablePortal) (0,lit__WEBPACK_IMPORTED_MODULE_3__.render)(null, this._tablePortal);
      return lit__WEBPACK_IMPORTED_MODULE_3__.nothing;
    }
    ...
    requestAnimationFrame(() => this.bindFilterTemplateDrag());
    return lit__WEBPACK_IMPORTED_MODULE_3__.nothing;
  }
  ...
  getColumnResizeLimits(column = {}, fallbackWidth = 0) {
    const minWidth = this.parseColumnSize(column.minWidth, null) ?? Math.min(Math.max(fallbackWidth, 28), 28);
  ...
  getPortalContainer() {
    if (this._tablePortal?.isConnected) return this._tablePortal;
    let portal = document.getElementById("sf-table-portal");

    if (!portal) {
      portal = document.createElement("div");
      portal.id = "sf-table-portal";
      document.body.append(portal);
    }

    this._tablePortal = document.createElement("div");
    this._tablePortal.className = "sf-table-portal-instance";
    portal.append(this._tablePortal);
    return this._tablePortal;
  }
  ...
  onDisconnected() {
    ...
    if (this._tablePortal) {
      (0,lit__WEBPACK_IMPORTED_MODULE_3__.render)(null, this._tablePortal);

      this._tablePortal.remove();

      this._tablePortal = null;
    }
    ...
    if (this.refs.contextMenu) this.refs.contextMenu.value = null;
    this.contextTarget?.classList.remove("active");
    this.contextTarget = null;
  }
  ...
  template() {
    return (0,_js_templates_default__WEBPACK_IMPORTED_MODULE_2__.renderTableTemplate)(this.templateContext());
  }
