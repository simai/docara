...
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");
/* harmony import */ var _default_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("a97bfab106ac");
...
function renderPanel(item, context) {
  ...
  const dataContent = item.panel?.component ? renderComponent(item.panel.component) : typeof item.panel?.text !== 'undefined' ? item.panel.text : lit__WEBPACK_IMPORTED_MODULE_0__.nothing;
  ...
  if (context.variant !== 'icons') {
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
          <sf-button
                  ...
                  icon-start=${item.iconStart ?? item.iconLeft ?? lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
                  icon-end=${item.iconEnd ?? item.iconRight ?? lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
...
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("ffe0a3e58c16");
...
function normalizeIndex(index, total) {
  const value = (0,_cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__.toNumber)(index, 0);
...
class SfTabs extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static get props() {
    return {
      templateName: {
        attribute: 'template',
  ...
  get panelSlotNames() {
    ...
    return Array.from(names).sort((a, b) => {
      return (0,_cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__.toNumber)(a.replace('panel-', ''), 0) - (0,_cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__.toNumber)(b.replace('panel-', ''), 0);
    });
  }
  ...
  handleRootKeyDown = event => {
    ...
    const currentEnabledIndex = enabledItems.findIndex(item => item.index === this.activeIndex);
    const nextEnabledIndex = (currentEnabledIndex + direction + enabledItems.length) % enabledItems.length;
    this.goTo(enabledItems[nextEnabledIndex]?.index);
  };
}
