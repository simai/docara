...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderTagTemplate: () => (/* binding */ renderTagTemplate)
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");
/* harmony import */ var _default_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("aacd16a208ea");
...
function renderCheckboxIcon(context) {
  return context.component?.hasSlotContent?.('leading') ? context.component.getSlotContent('leading') : (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
                <sf-checkbox
...
function renderGenericIcon(context) {
  ...
  return context.component?.hasSlotContent?.('leading') ? context.component.getSlotContent('leading') : (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<i class="sf-icon sf-tag-icon">${iconName}</i>`;
}

function renderColorIcon(context) {
  const extraClass = context.colorClass || '';
  return context.component?.hasSlotContent?.('leading') ? context.component.getSlotContent('leading') : (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class=${['sf-tag-color-icon', extraClass].filter(Boolean).join(' ')}></span>`;
}
...
function renderCount(context) {
  if (context.type !== 'default') return lit__WEBPACK_IMPORTED_MODULE_0__.nothing;
  return context.component?.hasSlotContent?.('count') ? context.component.getSlotContent('count') : (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="sf-tag-count pointer-events-none flex">${context.count || lit__WEBPACK_IMPORTED_MODULE_0__.nothing}</span>`;
}

function renderClose(context) {
  if (!context.closable) return lit__WEBPACK_IMPORTED_MODULE_0__.nothing;
  return context.component?.hasSlotContent?.('close') ? context.component.getSlotContent('close') : (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
                <sf-icon-button
                        variant="close"
...
function renderTagTemplate(context) {
  const textContent = context.component?.hasSlotContent?.('text') ? context.component.getSlotContent('text') : context.text;
  const classes = ['sf-tag', 'transition', `sf-tag--${context.type}`, `sf-tag--size-${context.size}`, 'inline-flex', 'flex-row', 'flex-nowrap', 'items-center', `${context.rootClass}`, context.active ? 'active' : '', context.disabled ? 'disabled' : ''].filter(Boolean);
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
        <div
                ...
                aria-pressed=${context.type === 'checkbox' ? String(context.active) : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
        >
...
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("a12697866146");



class SfTag extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static get props() {
    return {
      templateName: {
        attribute: 'template',
      ...
      type: {
        default: 'checkbox',
        values: ['checkbox', 'icon', 'default', 'color', 'avatar', 'success', 'error', 'warning']
      },
      size: {
        default: '1/2',
        values: ['1/2', '1']
  ...
  get type() {
    return this.getEnumAttr('type', ['checkbox', 'icon', 'quantity', 'color', 'avatar', 'success', 'error', 'warning'], 'checkbox');
  }

  get size() {
    return this.getEnumAttr('size', ['1/2', '1'], '1/2');
  }
  ...
  get colorClass() {
    return this.getAttribute('color-class') || '';
  }
  ...
  get avatarStatus() {
    return this.getAttribute('avatar-status') || '';
  }
  ...
  get active() {
    return this.getBooleanAttr('active', false);
  }
  ...
  get closable() {
    if (this.hasAttribute('closable')) {
      return this.getBooleanAttr('closable', true);
    }

    return ['icon', 'quantity', 'color', 'avatar'].includes(this.type);
  }
  ...
  template() {
    return (0,_js_templates_default__WEBPACK_IMPORTED_MODULE_1__.renderTagTemplate)(this.templateContext());
  }
  ...
  get value() {
    return {
      ...
      avatarStatus: this.avatarStatus,
      rootClass: this.rootClass,
      active: this.active,
