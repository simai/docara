...
/* harmony import */ var _json_textarea_utility_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("2a50752fa015");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderTextareaTemplate: () => (/* binding */ renderTextareaTemplate)
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");
/* harmony import */ var _component_field_contract__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("eff76bb8fe05");


function renderTextareaTemplate(context) {
  const {
    size,
    type,
    label,
  ...
  const rootClasses = ['sf-textarea', `sf-textarea--size-${size}`, `sf-textarea--${type}`, field.invalid ? 'error' : '', 'flex', 'flex-col'].filter(Boolean);
  const labelContent = label ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
        <span class="sf-textarea-text">${label}</span>
        ${required ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="sf-textarea-required">*</span>` : ''}
      ` : required ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="sf-textarea-required">*</span>` : '';
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _component_textarea_js_textarea__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("0f3b63f0d106");
/* harmony import */ var _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("dd9ac7709472");
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("3bbf2213925a");




class SfTextarea extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_1__["default"] {
  static get props() {
    return {
      size: {
        default: '1'
  ...
  get rows() {
    const value = Math.trunc(this.getNumberAttr('rows', 3));
  ...
  templateContext() {
    ...
    return this.createTemplateContext({ ...props,
      value: this.hasAttribute('value') || !textarea ? props.value : textarea.value
    });
  }

  onDisconnected() {
    if (this._boundRoot) {
      (0,_component_textarea_js_textarea__WEBPACK_IMPORTED_MODULE_0__.unbindTextarea)(this._boundRoot);
      this._boundRoot = null;
    }
  }
  ...
  afterRender() {
    ...
    this._boundRoot = this.querySelector('.sf-textarea');

    if (this._boundRoot) {
      (0,_component_textarea_js_textarea__WEBPACK_IMPORTED_MODULE_0__.bindTextarea)(this._boundRoot);
    }
  }

  template() {
    return (0,_js_templates_default__WEBPACK_IMPORTED_MODULE_2__.renderTextareaTemplate)(this.templateContext());
  }

  get state() {
    const root = this.querySelector('.sf-textarea');
    const textarea = root?.querySelector?.('textarea') || null;
    return {
      value: textarea?.value || '',
      disabled: !!textarea?.disabled,
      invalid: textarea?.getAttribute('aria-invalid') === 'true',
      error: root?.classList?.contains('error') || textarea?.classList?.contains('error') || false
    };
  }

  setState(nextState = {}) {
    const root = this.querySelector('.sf-textarea');
    return (0,_component_textarea_js_textarea__WEBPACK_IMPORTED_MODULE_0__.setTextareaState)(root, nextState);
  }

}

SfTextarea.define('sf-textarea');
})();
