...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderToastTemplate: () => (/* binding */ renderToastTemplate)
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");
...
function renderToastTemplate(context) {
  const rootClasses = joinClasses('sf-toast', `sf-toast--${context.type || 'default'}`, 'flex', 'items-cross-start', context.rootClass);
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
    <div class=${rootClasses}>
      ${context.icon ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<i class="sf-icon" aria-hidden="true">${context.icon}</i>` : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}

      <div class="sf-toast-container flex flex-col flex-1">
        <div class="sf-toast-wrap flex flex-col">
          ${context.title ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<div class="sf-toast-text">${context.title}</div>` : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
          ${context.supportingText ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<div class="sf-toast-supporting-text">${context.supportingText}</div>` : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
        </div>
...
/* harmony import */ var _component_toast_js_toast__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("41caf03f7d5a");
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("9c85256c830b");




class SfToast extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static get props() {
    return {
      type: {
        default: 'default'
  ...
  template() {
    return (0,_js_templates_default__WEBPACK_IMPORTED_MODULE_2__.renderToastTemplate)(this.templateContext());
  }

  afterRender() {
    if (this._boundRoot) {
      this.removeToastListeners(this._boundRoot);
      (0,_component_toast_js_toast__WEBPACK_IMPORTED_MODULE_1__.unbindToast)(this._boundRoot);
      this._boundRoot = null;
    }

    this._boundRoot = this.querySelector('.sf-toast');

    if (!this._boundRoot) {
      return;
    }

    (0,_component_toast_js_toast__WEBPACK_IMPORTED_MODULE_1__.bindToast)(this._boundRoot);
    this.addToastListeners(this._boundRoot);
  }
  ...
  addToastListeners(root) {
    root.addEventListener('sf-toast-close', this._handleToastClose);
  }

  removeToastListeners(root) {
    root.removeEventListener('sf-toast-close', this._handleToastClose);
  }
  ...
  dismiss() {
    if (this._boundRoot) {
      (0,_component_toast_js_toast__WEBPACK_IMPORTED_MODULE_1__.dismissToast)(this._boundRoot);
  ...
  onAction(handler, options) {
    if (typeof handler === 'function') {
      this.addEventListener('sf-toast-action', event => {
  ...
  onClose(handler, options) {
    if (typeof handler === 'function') {
      this.addEventListener('sf-toast-close', event => {
