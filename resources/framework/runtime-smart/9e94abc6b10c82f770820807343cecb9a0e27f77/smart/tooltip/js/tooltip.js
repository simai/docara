...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   renderTooltipTemplate: () => (/* binding */ renderTooltipTemplate)
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("c06304d43762");
...
function contentTemplate(context) {
  ...
  const supportingContent = context.component?.hasSlotContent?.('supporting-text') ? context.component.getSlotContent('supporting-text') : context.supportingText;
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
    <div class="sf-tooltip-content flex flex-col">
      ${textContent ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<div class="sf-tooltip-text">${textContent}</div>` : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
      ${supportingContent ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<div class="sf-tooltip-supporting-text">${supportingContent}</div>` : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
    </div>
  `;
}
...
function tailTemplate(context) {
  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<div class="sf-tooltip-tail"></div>`;
}

function renderTooltipTemplate(context) {
  const classes = ['sf-tooltip', `sf-tooltip--${context.type}`, `sf-tooltip--arrow-${context.arrow}`, `sf-tooltip--size-${context.size}`, 'relative'].filter(Boolean);
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
...
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("df7e3a502980");



class SfTooltip extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  static get props() {
    return {
      templateName: {
        attribute: 'template',
  ...
  template() {
    return (0,_js_templates_default__WEBPACK_IMPORTED_MODULE_1__.renderTooltipTemplate)(this.templateContext());
  }
