...
function renderLabel(context) {
  ...
  if (context.content !== lit__WEBPACK_IMPORTED_MODULE_0__.nothing) {
...
function renderTreeItemTemplate(context) {
  ...
  const toggleIcon = context.open ? context.openIcon : context.closedIcon;
  ...
  return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
        ...
        >
            <div class=${containerClasses}>
                ${!context.icon ? lit__WEBPACK_IMPORTED_MODULE_0__.nothing : context.isFile ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<sf-icon filled icon="draft"></sf-icon>` : (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
                            <button
                                    type="button"
                                    class="sf-icon-button sf-tree-toggle"
                                    ?disabled=${!canToggle || context.disabled}
                                    aria-expanded=${canToggle ? String(context.open) : 'false'}
                        ...
                        `}
                ${canToggle ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`<span class="sf-tree-chevron absolute" aria-hidden="true">
          ${renderIcon(chevronIcon)}
        </span>` : lit__WEBPACK_IMPORTED_MODULE_0__.nothing}
...
/* harmony import */ var _js_templates_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("0adfd43a9498");
...
class SfTreeItem extends _cl_classes_template_sfBaseElement__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  observeChildItems() {
    ...
    this._itemObserver = new MutationObserver(mutations => {
      ...
      if (!hasNewItems || !this.captureInitialItems()) {
        return;
      }
  ...
  captureInitialItems() {
    ...
    this._itemsData = nodes.map(treeItemNodeToData);
    nodes.forEach(node => node.remove());
    return true;
  }
  ...
  get childItems() {
    ...
    const propItems = this.getProp('itemsData');
