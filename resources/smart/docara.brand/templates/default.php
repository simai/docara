<a class="docara-brand docara-brand--size-<?= $view->size ?> flex items-cross-center gap-1 color-on-surface decoration-none" href="<?= $view->homeUrl ?>" data-docara-smart="docara.brand" data-docara-view="default">
