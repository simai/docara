                    ...
                    <tbody>
                        @foreach ($utilityExplorer['utilities'] as $utility)
                            <tr data-framework-catalog-entry data-framework-kind="{{ $utility['readiness']['status'] }}" data-framework-search="{{ $utility['search_text'] }}">
                                <td>
                                    <strong>{{ $utility['title'] }}</strong><code>{{ $utility['id'] }}</code><small>{{ $utility['purpose'] }}</small>
                                    @if ($utility['demonstration'] !== null)
                                        <a data-framework-utility-demo-link href="{{ route('larena.docara.admin.pages.framework.demonstration', ['entryId' => $utility['id']]) }}">{{ __('larena-docara::admin.framework_utilities.open_demo') }}</a>
                                    @endif
                                </td>
