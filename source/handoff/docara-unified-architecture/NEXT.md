# Next checkpoint: M4 integrated acceptance
...
Run all-route isolated parity, full PHPUnit/static/format/graph checks and the
complete desktop/mobile light/dark browser matrix. Update global acceptance
only for results demonstrated by that integrated evidence.
