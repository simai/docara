...
| G1.1 | versioned source-pinned SF5 Smart v1 snapshot/adapter and fixtures | pass candidate |
| G1.2 | descriptors/providers/compiler and ownership/path policy | ready |
...
Current remaining after G1.1: 5 batches. Do not complete until all Goal 1 Done
When rows are evidenced or a stated stop condition is recorded. Next safe
batch: commit G1.1 separately, then continue directly to G1.2.
