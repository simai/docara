...
Status: `acceptance_passed_handoff_pending`
...
M4.1-M4.5 are green. All 103 selected routes have physical Markdown owners and
pass through one typed PageBuilder artifact; generated public owners, public
projector paths and trusted-main/generated bypasses are zero. The all-route
full/single matrix, two deterministic full builds, static verifier, full tests
and browser acceptance pass. M4.6 reverse audit and handoff are active. M5,
