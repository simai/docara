...
- Docara exposes fullscreen for Example previews and visual wrapping for source
  tabs and ordinary code blocks without changing copied source.
...
- The clean existing worktree at tag `v2.7.5` is the release integration line.
