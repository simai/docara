...
| Implementation and acceptance evidence | `batch-4-reader-settings-implementation.md`; `batch-4-browser-ux-design-preacceptance.md`; this file | Records commands, deterministic digest, real-browser scenarios, product judgement and nonclaims. |
...
preference and are not a second theme system.
