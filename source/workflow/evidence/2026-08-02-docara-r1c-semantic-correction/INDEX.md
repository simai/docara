...
| R1-C.6 integrated retest | pending | — |
...
No current corrected candidate exists until R1-C.5 passes. Historical R1
evidence remains unchanged and must not be used to claim release readiness.
