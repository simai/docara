...
final readonly class DocaraPageAuditEventDescriptor implements AuditEventDescriptor
{
    ...
    {
        return 'docara_page_' . $this->operation;
    }
    ...
    {
        return ['body', 'password', 'password_hash', 'token', 'secret'];
    }
