...
namespace Simai\Docara\Collection;
...
class Collection extends BaseCollection
{
    ...
    public static function withSettings(IterableObject $settings, $name): static
    {
    ...
    public function updateItems(BaseCollection $items): static
    {
