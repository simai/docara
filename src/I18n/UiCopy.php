...
final readonly class UiCopy
{
    private const IDS = [
        ...
        'reader.ui_radius_default',
        'reader.ui_radius_default_description',
        'reader.ui_radius_medium',
        'reader.ui_radius_medium_description',
        'reader.ui_radius_large',
        'reader.ui_radius_large_description',
        'reader.saved',
