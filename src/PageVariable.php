<?php
    ...
    class PageVariable extends IterableObject
    {
        ...
        public function getPath($key = null)
        {
            ...
            $path = (string) $this->_meta->path;

            // If indexAsPage is set, ensure the path ends with "/index".
            if (($this->_meta->indexAsPage ?? false) && ! Str::endsWith($path, '/index')) {
                $path = rtrim($path, '/') . '/index';
            }

            return $this->enforceTrailingSlash($path);
        }
