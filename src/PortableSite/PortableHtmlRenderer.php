...
final class PortableHtmlRenderer
{
    ...
    private function documentation(array $page, array $navigation): string
    {
        ...
        return '    <div class="docara-docs-layout gap-3 p-3">' . "\n"
            ...
            . '            </nav>' . "\n"
            . '        </aside>' . "\n"
            . '        <main class="docara-content docara-prose bg-surface-0 border radius-2 p-3" data-width="'
    ...
    {
        return '    <main class="docara-landing flex flex-col gap-4 p-4">' . "\n"
    ...
    {
        return '    <header class="docara-header flex items-center content-main-between gap-2 p-2 bg-surface-0 border">' . "\n"
            . '        <a class="docara-brand weight-7" href="' . $this->escape($homeUrl) . '">' . $this->escape($siteTitle) . '</a>' . "\n"
            . '        <button id="docara-theme-toggle" class="docara-theme-toggle bg-surface-0 border radius-1 p-1" type="button" aria-label="Переключить тему">Тема: система</button>' . "\n"
            . '    </header>';
    }
    ...
    private function themeController(): string
    {
        return '<script data-docara-theme-controller>(function(){var button=document.getElementById(\'docara-theme-toggle\');if(!button)return;'
            . 'var labels={system:\'система\',light:\'светлая\',dark:\'тёмная\'};function apply(mode){var dark=mode===\'dark\'||(mode===\'system\'&&window.matchMedia&&window.matchMedia(\'(prefers-color-scheme: dark)\').matches);'
            . 'document.cookie=mode===\'system\'?\'sf-theme=; Path=/; Max-Age=0; SameSite=Lax\':\'sf-theme=\'+mode+\'; Path=/; Max-Age=31536000; SameSite=Lax\';document.documentElement.classList.remove(\'theme-light\',\'theme-dark\');document.documentElement.classList.add(dark?\'theme-dark\':\'theme-light\');document.documentElement.dataset.docaraTheme=mode;button.textContent=\'Тема: \'+labels[mode];button.setAttribute(\'aria-pressed\',mode===\'dark\'?\'true\':\'false\');}'
    ...
    {
        return <<<'CSS'
html{color-scheme:light dark}.theme-light{color-scheme:light}.theme-dark{color-scheme:dark}body{min-height:100vh;background:var(--sf-surface-1);color:var(--sf-on-surface)}.docara-header{position:sticky;inset-block-start:0;z-index:20;border-width:0 0 var(--sf-px) 0}.docara-brand,.docara-nav-link{color:var(--sf-on-surface);text-decoration:none}.docara-theme-toggle{color:var(--sf-on-surface);font:inherit}.docara-docs-layout{display:grid;grid-template-columns:minmax(13rem,17rem) minmax(0,1fr);max-width:96rem;margin-inline:auto}.docara-sidebar{align-self:start;position:sticky;inset-block-start:5rem}.docara-content{min-width:0;color:var(--sf-on-surface)}.docara-content[data-width="compact"]{max-width:45rem}.docara-content[data-width="normal"]{max-width:60rem}.docara-content[data-width="wide"]{max-width:80rem}.docara-content[data-width="full"]{max-width:none}.docara-prose{line-height:1.65}.docara-prose>*+*{margin-block-start:var(--sf-space-2)}.docara-prose h1{font-size:clamp(2rem,5vw,4rem);line-height:1.08;font-weight:750;letter-spacing:-.035em}.docara-prose h2{font-size:clamp(1.45rem,3vw,2.25rem);line-height:1.2;font-weight:700;margin-block-start:var(--sf-space-4)}.docara-prose h3{font-size:1.25rem;line-height:1.3;font-weight:650;margin-block-start:var(--sf-space-3)}.docara-prose p,.docara-prose li{max-width:72ch}.docara-prose pre{max-width:100%;overflow:auto;background:var(--sf-surface-container);padding:var(--sf-space-2);border-radius:var(--sf-radius-2)}.docara-prose code{font-family:var(--sf-mono,ui-monospace,monospace)}.docara-prose table{display:block;max-width:100%;overflow:auto;border-collapse:collapse}.docara-prose th,.docara-prose td{padding:var(--sf-space-1);border:var(--sf-px) solid var(--sf-outline-variant)}.docara-landing{align-items:center;justify-content:center;min-height:calc(100vh - 5rem)}.docara-landing .docara-content{width:min(100%,80rem)}sf-alert,sf-button{display:block}.docara-prose sf-alert,.docara-prose sf-button{margin-block:var(--sf-space-2)}@media(max-width:800px){.docara-docs-layout{grid-template-columns:minmax(0,1fr);padding:var(--sf-space-1)}.docara-sidebar{position:static}.docara-content{padding:var(--sf-space-2)}.docara-header{position:relative}.docara-landing{padding:var(--sf-space-1);min-height:auto}}
CSS;
    }
