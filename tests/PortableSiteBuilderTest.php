...
MD);
    ...
    public function it_builds_docs_landing_inheritance_components_and_explainable_plans(): void
    {
        ...
        foreach ([$index, $guide, $fourthLevel, $landing] as $html) {
            ...
            self::assertStringContainsString(
                '/_docara/vendor/simai-framework/runtime/56cd91e1d7a3dc19b32a2acfdaa1389744e174a7/distr/',
                $html,
            );
        ...
        self::assertSame('ui-56cd91e1d7a3-smart-903ad66c4f4f', $componentCatalog['framework_pair']);
...
MD;
    ...
    public function base_url_scopes_routes_and_revisioned_local_framework_assets(): void
    {
        ...
        self::assertMatchesRegularExpression(
            '#/project~/docs/_docara/framework-runtime/smart/alert/js/alert\.js\?sf_v=ui-56cd91e1d7a3-smart-903ad66c4f4f-[a-f0-9]{16}#',
            $diagnostics,
        );
