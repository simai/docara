...
$slotCode = htmlspecialchars((string) ($slot ?? ''), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8');
echo '<aside data-fixture-notice data-view="' . $viewCode . '" data-preset="' . $presetCode . '" data-slot="' . $slotCode . '"><strong>' . $title . '</strong><p>' . $text . '</p></aside>';
